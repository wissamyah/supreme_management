        ...
        users.forEach(user => {
            ...
            tr.innerHTML = `
                ...
                <td>
                    ...
                    <button class="btn btn-sm btn-warning toggle-status" data-id="${user.id}" data-status="${user.status || 'Active'}">
    ...
    function attachButtonListeners() {
        ...
        document.querySelectorAll('.edit-user').forEach(button => {
            button.addEventListener('click', function() {
                ...
                fetch(`../../api/users/read.php?id=${userId}`)
                    .then(response => {
                        if (!response.ok) throw new Error('Network response was not ok');
                        return response.json();
                    })
        ...
        document.querySelectorAll('.toggle-status').forEach(button => {
            button.addEventListener('click', function() {
                ...
                showConfirmDialog(
                    ...
                    `Are you sure you want to ${currentStatus === 'Active' ? 'block' : 'unblock'} this user?`,
                    () => {
                        fetch('../../api/users/update.php', {
                            method: 'POST',
                            headers: {
