...
if (!isset($_SESSION['user_id'])) {
    header('Location: /supreme_management/login.php');
    exit();
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Fetch user data
    fetch(`/supreme_management/api/users/read.php?id=${userId}`)
    ...
    profileForm.addEventListener('submit', function(e) {
        ...
        fetch('/supreme_management/api/users/update.php', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            if (data.success) {
                ...
                fetch('/supreme_management/api/users/update_session.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
